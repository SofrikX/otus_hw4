...
create policy "posts_insert_own_pet"
...
create policy "walks_read_active_authenticated"
...
create policy "walk_participants_insert_self_active_walk"
...
create policy "chat_participants_insert_self_or_existing_participant"
...
with check (
  ...
  and (
    ...
    or not exists (
      select 1
      from public.chat_participants existing_participant
